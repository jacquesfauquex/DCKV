...
enum MDBX_env_flags_t {
  ...
  /** Please use \ref MDBX_SAFE_NOSYNC instead of `MDBX_MAPASYNC`.
   *
 ...
 * \ingroup c_crud
 * \see c_crud_hints "Quick reference for Insert/Update/Delete operations"
 ...
 * It is recommend not using custom comparison functions, but
...
#pragma mark -
#pragma mark store replace delete
...
#pragma mark -
#pragma mark cursor instanciation
